...
void loop()
{
  ...
  {
    Serial.println("sensor 1 " + sensor_values[1]);
    motors.setSpeeds(0,0);
  }
  else if (sensor_values[2] > 200)
  {
    Serial.println("sensor 2 " + sensor_values[2]);
    motors.setSpeeds(0,0);
  }
  else if (sensor_values[3] > 200)
  {
    
    Serial.println("sensor 3 " + sensor_values[3]);
    motors.setSpeeds(0,0);
  }
  else if (sensor_values[4] > 200)
  {
    Serial.println("sensor 4 " + sensor_values[4]);
    motors.setSpeeds(0,0);
  }
